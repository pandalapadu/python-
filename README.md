...
def notify(body, to):
    ...
    sender_email = "certibot@exple.com"  # Enter your address
        ...
        for future in concurrent.futures.as_completed(futures):
            ...
            try:
                ...
                if days_remaining < WARN_IF_DAYS_LESS_THAN:
                    print(f"sending mail  for {host}")
                    notify(body=f"Certificate for {host} is expiring", to="someguy@exmple.com")
